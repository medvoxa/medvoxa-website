...
export default function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-[#C9B8AE] shadow-sm">
      ...
      {/* MOBILE DRAWER */}
      {open && (
        <div className="fixed inset-0 z-[60] bg-[#F4E9E4] text-[#2A2220] px-6 py-6 overflow-y-auto">
